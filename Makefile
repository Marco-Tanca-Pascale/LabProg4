...
Alojamiento.o: Lab0/src/Alojamiento.cpp Lab0/include/Alojamiento.h
		g++ -Wall -g -c Lab0/src/Alojamiento.cpp -o Alojamiento.o 

DTExpe.o: Lab0/src/DTExpe.cpp Lab0/include/DTExpe.h
...
EventoCultural.o: Lab0/src/EventoCultural.cpp Lab0/include/EventoCultural.h
		g++ -Wall -g -c Lab0/src/EventoCultural.cpp -o EventoCultural.o

Experiencia.o: Lab0/src/Experiencia.cpp Lab0/include/Experiencia.h
		g++ -Wall -g -c Lab0/src/Experiencia.cpp -o Experiencia.o

TourGuiado.o: Lab0/src/TourGuiado.cpp Lab0/include/TourGuiado.h
		g++ -Wall -g -c Lab0/src/TourGuiado.cpp -o TourGuiado.o
	
Turista.o: Lab0/src/Turista.cpp Lab0/include/Turista.h
